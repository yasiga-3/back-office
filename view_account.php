...
<body class="body-bg">
    ...
    <div class="page-container">
        ...
        <div class="main-content">
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix" style="padding: 10px;">
                            ...
                            <ul class="breadcrumbs pull-left">
                                <li><a href="user_management.php">Admin</a></li>
            ...
            <!-- page title area end -->
        <!-- page title area end -->
        <h2 style="text-align:center;margin-top:2%;margin-bottom:-1.5%;">Profile</h2>
                ...
                <div class="col-lg-6 col-ml-12">
                        <div class="row">
                            ...
                            <div class="col-12 mt-5">
                                <div class="card">
                                    <div class="card-body">
                                        <form role="form" action="view_account.php" method="post">
			                        ...
			                        <div class="col-xs-12 col-sm-6 col-md-6">
			                            <label tabindex="17">Applicable for PLB</label><br><br>
			                        ...
			                        <div class="form-group">
				                        ...
				                        <select type="number" name="status" id="status" class="custom-select"  tabindex="15" required>
                                        <?php 
