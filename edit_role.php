...
<head>
    ...
    <title>Sharkfin ventures - Edit role</title>
                ...
                <div class="col-lg-6 col-ml-12">
                        <div class="row">
                            ...
                            <div class="col-12 mt-5">
                                <div class="card">
                                    <div class="card-body">
                                        <form role="form" action="edit_role.php" method="post">
                                            <input type="hidden" name="id"  value="<?php echo $id; ?>">
			                                <div class="form-group">
			                                    <label class="col-form-label">Role Name</label>
				                                <input type="text" name="role" id="role" value="<?php echo $role; ?>" class="form-control " placeholder="role name" tabindex="1" required>
			                                </div>
                                            <div class="form-group">
                                                <label class="col-form-label">Status</label>
				                                <select type="text" name="status" id="status" class="custom-select" tabindex="2" required>
...
if(isset($_POST['submit'])){
	...
	$query = "update roles set role = '".$role."', status = '".$status."' where id='".$id."'";
	$execute = mysqli_query($con, $query);

	if($execute){
		if(isset($_SESSION['id'])){
            $_SESSION['success_message'] = 'Success! Role altered successfully.';
