...
<head>
    ...
    <title>Sharkfin ventures - Roles</title>
                ...
                <div class="col-12 mt-5">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a role="button" type="submit" class="btn btn-primary" href="create_role.php" style="margin-bottom:10px;">Add</a>
...
<table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="99%">
						            ...
						            <tr>
                                        ...
                                        <?php    if($id > 3){ ?>
                                        <td><a href="edit_role.php?id=<?php echo $row['id']; ?>"><i class="fa fa-pencil"></i></a>&nbsp;&nbsp;&nbsp;<a onclick="return confirm('Are you sure, you want to delete it?')" href="delete_role.php?id=<?php echo $row['id']; ?>"><i class="fa fa-times"></i></a></td>
                                        <?php }else { 
                                            echo '<td></td>';
                                        } ?>
						            </tr> 
