                ...
                <div class="row align-items-center" >
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix" style="padding: 10px;">
                            <h4 class="page-title pull-left">Add Scheme</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="user_management.php">Scheme</a></li>
                                <li><span>Add Scheme</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-ml-12">
                        <div class="row">
                            ...
                            <div class="col-12 mt-5">
                                <div class="card">
                                    <div class="card-body">
                                        <form role="form" action="add_scheme.php" method="post">
                                            <div class="form-group">
                                                <label class="col-form-label">Scheme name</label>
                                                <input type="text" name="name" id="name" class="form-control" placeholder="scheme name" tabindex="1" required>
					                       </div>
                                           <div class="form-group">
                                               <label class="col-form-label">Capital</label>
                                                <input type="number" name="capital" id="capital" class="form-control" placeholder="capital" tabindex="2" required>
					                       </div>
					                       <div class="form-group">
					                           <label class="col-form-label">ROI</label>
						                       <input type="number" name="roi" id="roi" class="form-control" placeholder="ROI" tabindex="3" required>
					                       </div>
			                               <div class="form-group">
			                                   <label class="col-form-label">PLB</label>
				                               <input type="number" name="plb" id="plb" class="form-control" placeholder="Fixed(PLB)" tabindex="4" required>
			                                </div>
			                                <div class="form-group">
			                                    <label class="col-form-label">Fiscal year</label>
						                        <input type="month" name="fiscal_year" id="fiscal_year" placeholder="fiscal Year" class="form-control" tabindex="5" required>
					                        </div>
...
if(isset($_POST['submit'])){
	...
	$query = "insert into scheme (capital, ROI, PLB, fiscal_year) values('".$capital."', '".$roi."', '".$plb."', '".$fiscal_year."')";
	$execute = mysqli_query($con, $query);

	if($execute){
		if(isset($_SESSION['id'])){
            $_SESSION['success_message'] = 'Success! Scheme added successfully.';
